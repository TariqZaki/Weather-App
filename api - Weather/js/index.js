  ...
  for (let i = 0; i < cities.forecast.forecastday.length; i++) {
    ...
    if (i == 0) {
     ...
     <div class="col-md-12  mx-auto">
                    <div class="mainCard mt-2 rounded-4 p-3 mx-auto text-white">
      ...
      cartona += `
             <div class="col-md-2 my-3">
                    <div class="secondCard d-flex flex-column justify-content-center align-items-center rounded-4 text-white p-3 shadow-lg">
                        <div class="dayName  border-1 border-bottom border-dark shadow-lg p-2">
                            <span>${days[date.getDay()]}</span>
                        </div>
                        <div class="statusIcon">
                            <img src="https:${cities.forecast.forecastday[i].day.condition.icon}" alt="">
                        </div>
                        <div class="maxTemp">
